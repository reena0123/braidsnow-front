			...
			<div class="row align-items-center">
				<div class="col-md-8 col-12">
					<nav aria-label="breadcrumb" class="page-breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Theraphist Profile</li>
						</ol>
					</nav>
					<h2 class="breadcrumb-title">Theraphist Profile</h2>
				</div>
					...
					<div class="provider-widget">
						<div class="pro-info-left">
							<div class="provider-img">
								<img src="assets/img/theraphist/theraphist-thumb-01.jpg" class="img-fluid" alt="User Image">
							</div>

							<div class="pro-info-cont">
								<h4 class="pro-name">Ashley Willes</h4>
								<p class="pro-speciality">Hair stylist, Theraphist</p>
								<p class="pro-department"><img src="assets/img/spa.png" class="img-fluid" alt="Speciality">Theraphist</p>
								...
								<div class="clinic-details">
									<p class="pro-location"><i class="fas fa-map-marker-alt"></i> Newyork, USA - <a href="javascript:void(0);">Get Directions</a></p>
						...
						<div class="pro-info-right">
							...
							<div class="clinic-booking">
								<router-link :to="{name:'Booking'}" class="apt-btn">Book Appointment
								</router-link>
							</div>
						</div>
					</div>
									...
									<div class="widget education-widget">
										...
										<div class="experience-box">
											<ul class="experience-list">
												...
												<div>Diploma in Beauty Therapy</div>
									...
									<div class="widget experience-widget">
										...
										<div class="experience-box">
											<ul class="experience-list">
												...
												<div class="experience-content">
												<div class="timeline-content">
												<a href="#/" class="name">Glowing Smiles Family spa</a>
												...
												<div class="experience-content">
												<div class="timeline-content">
												<a href="#/" class="name">Comfort Care spa Clinic</a>
												...
												<div class="experience-content">
												<div class="timeline-content">
												<a href="#/" class="name">Dream Smile spa Practice
												</a>
									...
									<div class="widget awards-widget">
										...
										<div class="experience-box">
											<ul class="experience-list">
												...
												<h4 class="exp-title">The spa Professional of The Year Award</h4>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
												</div>
												</div>
												</li>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="clinic-content">
											...
											<p class="pro-speciality">Theraphist</p>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i> 
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star"></i>
												<span class="d-inline-block average-rating">(4)
												</span>
											</div>
										...
										<div class="widget-content">
											<div class="listing-hours">
												<div class="listing-day current">
													...
													<div class="day">Today <span>5 Apr 2021</span>
													</div>
