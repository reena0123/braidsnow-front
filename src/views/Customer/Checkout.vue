				...
				<div class="col-md-7 col-lg-8">
					<div class="card">
						<div class="card-body">
							...
							<form action="https://pathivu.dreamguystech.com/dreamspa/booking-success.html">
								...
								<div class="payment-widget">
									...
									<div class="submit-section mt-4">
										<router-link :to="{name:'BookingSuccess'}" class="btn btn-primary submit-btn">Confirm and Pay</router-link>
									</div>
					...
					<div class="card booking-card">
						...
						<div class="card-body">
							...
							<div class="booking-pro-info">
								<a href="theraphist-profile.html" class="booking-pro-img">
								<img src="assets/img/theraphist/theraphist-thumb-01.jpg" alt="User Image">
								</a>
								<div class="booking-info">
									<h4><a href="theraphist-profile.html">Ashley Willes</a></h4>
									<div class="rating">
							...
							<div class="booking-summary">
								<div class="booking-item-wrap">
									<ul class="booking-date">
										<li>Date <span>16 Apr 2021</span></li>
