		...
		<div class="container-fluid">
			<div class="row align-items-center">
				<div class="col-md-12 col-12">
					...
					<li class="breadcrumb-item active" aria-current="page">Theraphist Profile Setting</li>
					</ol>
					</nav>
					<h2 class="breadcrumb-title">Theraphist Profile Setting</h2>
				</div>
			</div> 
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 col-lg-8 col-xl-9">
					...
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Spa Info</h4>
							<div class="row form-row">
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Spa Address</label>
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<label>Spa Images</label>
					...
					<div class="card services-card">
						<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" data-role="tagsinput" class="input-tags form-control" placeholder="Enter Services" name="services" value="Hair Treatment" id="services">
								<small class="form-text text-muted">Note : Type & Press enter to add new services</small>
							</div>
							<div class="form-group mb-0">
								<label>Specialization </label>
								<input class="input-tags form-control" type="text" data-role="tagsinput" placeholder="Enter Specialization" name="specialist" value="Skin Care,Massage" id="specialist">
